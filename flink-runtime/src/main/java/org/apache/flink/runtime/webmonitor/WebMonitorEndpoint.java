...
public class WebMonitorEndpoint<T extends RestfulGateway> extends RestServerEndpoint
    ...
    @Override
    /**  这里会为web monitor 创建很多的后端的 web 处理器      */
    ...
    public void startInternal() throws Exception {
        ...
        /** 参与选举的某个获胜的角色会调用   leaderContender.isLeaser() -> leaderContender.grantLeaderShip()
         *  失败则调用                    leaderContender.notLeader()
         *
         *  leaderContender的 实现类是   ZooKeeperLeaderElectionService
         * */
