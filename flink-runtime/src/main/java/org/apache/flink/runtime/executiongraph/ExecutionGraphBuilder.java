 ...
 * JobGraph}.
 * 在ExecutionGraphBuilder#buildGraph 任务执行树过程中，如果作业开启了checkpoint，则会调用
 * ExecutionGraph.enableCheckpointing() 方法, 这里会创建 CheckpointCoordinator 对象，并
 * 注册一个作业状态的监听 CheckpointCoordinatorDeActivator, CheckpointCoordinatorDeActivator
 * 会在作业状态发生改变时得到通知
 */
...
public class ExecutionGraphBuilder {
    ...
    public static ExecutionGraph buildGraph(
        ...
        if (snapshotSettings != null) {
            ...
            /**在ExecutionGraphBuilder#buildGraph 任务执行树过程中，如果作业开启了checkpoint，
             * 则会调用ExecutionGraph.enableCheckpointing() 方法, 这里会创建 CheckpointCoordinator
             * 对象，并注册一个作业状态的监听 CheckpointCoordinatorDeActivator, CheckpointCoordinatorDeActivator
             * 会在作业状态发生改变时得到通知
             *
             */
