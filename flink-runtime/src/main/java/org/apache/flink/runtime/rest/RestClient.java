...
public class RestClient implements AutoCloseableAsync {
    ...
    public RestClient(RestClientConfiguration configuration, Executor executor) {
        ...
        /**  在RestClient 的内部其实就是实现初始化了  Netty 的客户端 */
    ...
    public <
        ...
        //submitRequest方法通过Netty的channel与jobmanager进行远程通信，主要就是
        // 将包装好的httpRequest请求写入Netty channel中完成远程异步请求。
