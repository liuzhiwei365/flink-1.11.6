...
public final class StreamTaskNetworkInput<T> implements StreamTaskInput<T> {
    ...
    public InputStatus emitNext(DataOutput<T> output) throws Exception {
        ...
        while (true) {
            ...
            if (currentRecordDeserializer != null) {
                /** 解析出来的 StreamRecord 数据会存放在currentRecordDeserializer 中*/
            ...
            /**循环调用checkpointedInputGate.pollNext() 方法获取数据,　*/
    ...
    /**  StreamElement 包括 WaterMark  StreamStatus  LatencyMarker  StreamRecord
     *
     * */
